  ...
  L.geoJSON(data,{
    ...
    pointToLayer: function (feature, latlng) {
      ...
      switch(feature.properties.state) {
        case "In progress" :
          pre_icon.url = 'static/resources/State_In_Progress_icon.png';
          myIcon = L.icon(pre_icon);
          break;
        case "Done" :
          pre_icon.url = 'static/resources/State_Done_icon.png';
          myIcon= L.icon(pre_icon);
          break;
        default :
          pre_icon.url = 'static/resources/State_Untreated_icon.png';
          myIcon= L.icon(pre_icon);
          break;
      }
